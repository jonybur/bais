...
class BAEventCard : ASButtonNode{
    ...
    init (event : Event, yPosition : CGFloat){
		...
		self.leftButton.setTitle("Interested           ", with: UIFont.systemFont(ofSize: 14, weight: UIFontWeightMedium), with: ColorPalette.grey, for: ASControlState());
		...
		self.rightButton.setTitle("Going           ", with: UIFont.systemFont(ofSize: 14, weight: UIFontWeightMedium), with: ColorPalette.grey, for: ASControlState());
	...
	@objc func setRSVPStatus(_ notification: Notification) {
		...
		case "Maybe":
			...
			self.singleButton.setTitle("Interested                      ", with: UIFont.systemFont(ofSize: 14, weight: UIFontWeightMedium), with: ColorPalette.grey, for: ASControlState());
		...
		case "Attending":
			...
			self.singleButton.setImage(UIImage(named: "checked-button"), for: ASControlState());
			self.singleButton.setTitle("Going                       ", with: UIFont.systemFont(ofSize: 14, weight: UIFontWeightMedium), with: ColorPalette.grey, for: ASControlState());
			self.singleButton.alpha = 1;
