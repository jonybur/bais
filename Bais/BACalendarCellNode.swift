...
class BACalendarCellNode: ASCellNode {
	...
	func setButtonsFor(rsvpStatus: RSVPStatus){
		...
		case .declined:
			...
			leftButtonNode.setTitle("Interested", with: UIFont.init(name: "Nunito-SemiBold", size: 14), with: ColorPalette.grey, for: [])
			rightButtonNode.setTitle("Going", with: UIFont.init(name: "Nunito-SemiBold", size: 14), with: ColorPalette.grey, for: [])
			break
		case .maybe:
			// 1 button, "interested"
			singleButtonNode.setTitle("Interested", with: UIFont.init(name: "Nunito-SemiBold", size: 14), with: ColorPalette.grey, for: [])
			break
		case .attending:
			// 1 button, "going"
			singleButtonNode.setTitle("Going", with: UIFont.init(name: "Nunito-SemiBold", size: 14), with: ColorPalette.grey, for: [])
			break
		case .undefined:
			singleButtonNode.setTitle("", with: UIFont.init(name: "Nunito-SemiBold", size: 14), with: ColorPalette.grey, for: [])
			break
		}
	}
